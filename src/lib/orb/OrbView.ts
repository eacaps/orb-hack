...
import { IPosition, isEqualPosition } from "@memgraph/orb/dist/common";
import { ISimulator, SimulatorFactory } from "@memgraph/orb/dist/simulator";
import { IGraph } from "@memgraph/orb/dist/models/graph";
import { INode, INodeBase, isNode } from "@memgraph/orb/dist/models/node";
import { IEdgeBase, isEdge } from "@memgraph/orb/dist/models/edge";
import { IOrbView, IOrbViewContext } from "@memgraph/orb/dist/views/";
import { IEventStrategy } from "@memgraph/orb/dist/models/strategy";
import { ID3SimulatorEngineSettingsUpdate } from "@memgraph/orb/dist/simulator/engine/d3-simulator-engine";
import { copyObject } from "@memgraph/orb/dist/utils/object.utils";
import { OrbEmitter, OrbEventType } from "@memgraph/orb/dist/events";
import {
  IRenderer,
  RenderEventType,
  IRendererSettingsInit,
  IRendererSettings,
} from "@memgraph/orb/dist/renderer/shared";
import { RendererFactory } from "@memgraph/orb/dist/renderer/factory";
import { setupContainer } from "@memgraph/orb/dist/utils/html.utils";
import { SimulatorEventType } from "@memgraph/orb/dist/simulator/shared";
...
export class OrbView<N extends INodeBase, E extends IEdgeBase> implements IOrbView<IDefaultViewSettings<N, E>> {
